...
if analyse:
    ...
    contour = plt.tricontourf(x, y, z, cmap="Greens", levels=50, vmax=100)
    ...
    mat = plt.imshow(phase_space, cmap='Blues', vmax=50, interpolation='none', origin='Lower', extent=[0,1,0,1], alpha=0.75)
    plt.colorbar(mat)
    plt.tight_layout()
    print('total time = %5.5fs'%(time.time()-total_time)) 
    plt.show()